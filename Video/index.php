...
<?php } ?>
    ...
    <section class="u-align-center u-black u-border-7 u-border-white u-clearfix u-section-1" id="sec-9eac">
      <div class="u-clearfix u-sheet u-valign-middle-xs u-sheet-1">
        <div class="u-align-left u-expanded-width-sm u-expanded-width-xs u-video u-video-1">
          <div class="embed-responsive embed-responsive-1">
            <iframe style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;" class="embed-responsive-item" src="https://www.youtube.com/embed/kl-c6ZTnOzk?mute=0&amp;showinfo=0&amp;controls=0&amp;start=0" frameborder="0" allowfullscreen=""></iframe>
          </div>
        </div>
        <h2 class="u-text u-text-default u-text-1">How to Read A Nutrition Label</h2>
        <p class="u-text u-text-2">This video reviews the fundamental details that allow you to correctly read a Nutrition Label.</p>
      </div>
    </section>
